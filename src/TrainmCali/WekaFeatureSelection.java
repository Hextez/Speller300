...
public class WekaFeatureSelection {
	...
	public static void main(String[] args) throws Exception {
		...
		PrintWriter pw = new PrintWriter(new File("OfflineTest//Correlation//CorrelationNormalizado.txt"));
		//PrintWriter pw = new PrintWriter(new File("OfflineTest//Gain//GainInfoNormalizado.txt"));
		...
		for (Entry<Double, Integer> val : manyTimes.entrySet()) {
			sb.append(listaFeatures[((int) val.getKey().doubleValue())-1] +" apareceu: "+val.getValue()+"\n");
		}
